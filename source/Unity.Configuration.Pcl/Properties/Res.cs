namespace Unity.Configuration.Properties
{
    public static class Res
    {
        ...
        public static string CannotCreateInjectionMemberElement
            => "An abstract InjectionMemberElement object cannot be created.Please specify a concrete type.";
        public static string CannotCreateParameterValueElement
        ...
        public static string DependencyForGenericParameterWithTypeSet
            => "The dependency element for generic parameter {0} must not have an explicit type name but has '{1}'.";
        public static string DependencyForOptionalGenericParameterWithTypeSet
        ...
        public static string ElementWithAttributesAndParameterValueElements
        ...
        public static string InvalidExtensionElementType
            =>
        ...
        public static string InvalidValueAttributes
        ...
        public static string NoSuchContainer
        ...
        public static string ValueNotAllowedForGenericArrayType
            =>
        ...
        public static string ValueNotAllowedForGenericParameterType
            =>
        ...
        public static string ValueNotAllowedForOpenGenericType
            =>
